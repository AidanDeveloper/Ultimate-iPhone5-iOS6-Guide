# The ultimate iPhone 5 iOS 6 guide
I love the iPhone 5, it's one of my favorite iPhones ever made... But what if we make it **better** and *faster*?
# [Step 1] Jailbreaking iOS 
Jailbreaking legacy versions of iOS is so easy, what you need is:

Your iPhone 5 running iOS 6 to 10.3.4
...
# [Step 4] Extras ⭐ (i will add more)
**Installing apps with Veteris**
You want to install apps right? Well, it's kinda impossible now because of the App Store changes 

Open cydia and add this repo `http://yzu.moe/dev/` and install veteris from the `utility` sub-folder

To make it work You will need AppSyncUnified from `https://cydia.akemi.ai`
